...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "import-service")
	...
	v.SetDefault("database.schema", "data_import")
	...
	v.SetDefault("jwt.issuer", "import-service")
	...
	v.SetDefault("migration.table", "import_schema_migrations")
	...
	v.SetDefault("import.job_timeout", "2h")
	v.SetDefault("import.batch_size", 500)
	v.SetDefault("import.max_rows", 1000000)
...
func (c Config) Validate() error {
	...
	if c.Import.UploadTTL <= 0 || c.Import.ResultTTL <= 0 || c.Import.JobTimeout <= 0 || c.Import.BatchSize < 1 || c.Import.BatchSize > 10000 || c.Import.MaxRows < 1 || c.Import.MaxBytes < 1 {
		return errors.New("import requires positive TTLs, timeout, limits, and batch_size between 1 and 10000")
	}
