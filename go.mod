module github.com/lihongjie0209/import-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.9.0
	github.com/lihongjie0209/platform-protos v0.17.0
